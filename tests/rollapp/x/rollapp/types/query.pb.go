...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_428735e333fb35b7, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_428735e333fb35b7, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "rollapp.rollapp.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "rollapp.rollapp.QueryParamsResponse")
}

func init() { proto.RegisterFile("rollapp/rollapp/query.proto", fileDescriptor_428735e333fb35b7) }

var fileDescriptor_428735e333fb35b7 = []byte{
	// 292 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2e, 0xca, 0xcf, 0xc9,
	0x49, 0x2c, 0x28, 0xd0, 0x87, 0xd1, 0x85, 0xa5, 0xa9, 0x45, 0x95, 0x7a, 0x05, 0x45, 0xf9, 0x25,
	...
	0x9c, 0xc4, 0x06, 0x0e, 0x21, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x41, 0x74, 0x77, 0x93,
	0xe2, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rollapp.rollapp.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rollapp.rollapp.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "rollapp.rollapp.Query",
	...
	Metadata: "rollapp/rollapp/query.proto",
}
