...
Once the chain is properly configured, head over to the [Quickstart](../validators/v1.0.10/quickstart) guide to learn how to start the node with a Connect sidecar.
