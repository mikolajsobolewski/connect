...
<CardGroup cols={2}>
    <Card title="Validator Setup" icon="circle-nodes" href="/validators/v1.0.10/quickstart">
        Learn how to setup and run Connect with your infrastructure.
    </Card>
    <Card title="Using the API" icon="laptop-code" href="/developers/v1.0.10/high-level">
